        ...
        <div className="footer">
            <section>
                <div className="foot-row">
                    ...
                    <a href="#" target="_blank" className="img"><img className='mini' src="https://gineousc.sirv.com/Images/icons/twitter.png" alt="social icon" /></a>
                    <a href="https://instagram.com/offrcloud?igshid=NTc4MTIwNjQ2YQ==" target="_blank" className="img"><img className='mini' src="https://gineousc.sirv.com/Images/icons/instagram-new--v1.png" alt="social icon" /></a>
                </div>
